...
def main():
    ...
    lm = dspy.LM("openai/gpt-4.1-mini", temperature=1.0, api_key=OPENAI_API_KEY, max_tokens=32000)
    ...
    # 最適化前のプログラムを保存
    program.save("./artifacts/aime_baseline.json")

    # 最適化後のプログラムを保存
    optimized_program.save("./artifacts/aime_optimized_gepa.json")
